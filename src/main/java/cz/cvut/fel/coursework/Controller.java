...
public class Controller {
    ...
    public void setIP() {
        ...
        try {
            LOG.addHandler(new FileHandler("logs/IPIdentifier/controller.log"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void setAppDirectory() {
        ...
        LOG.setUseParentHandlers(false);
        try {
            LOG.addHandler(new FileHandler("logs/AppDirectory/controller.log"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void setPathToImage() {
        ...
        LOG.setUseParentHandlers(false);
        try {
            LOG.addHandler(new FileHandler("logs/AppDirectory/PathToImage.log"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void saveQR() {
        ...
        LOG.setUseParentHandlers(false);
        try {
            LOG.addHandler(new FileHandler("logs/QRGenerator/controller.log"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public String getOS() {
        ...
        LOG.setUseParentHandlers(false);
        try {
            LOG.addHandler(new FileHandler("logs/OSDetector/log.log"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void initializeGUI() {
        ...
        LOG.setUseParentHandlers(false);
        try {
            LOG.addHandler(new FileHandler("logs/GUI/log.log"));
        } catch (IOException e) {
            e.printStackTrace();
        }
