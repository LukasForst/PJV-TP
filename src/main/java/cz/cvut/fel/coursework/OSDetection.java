...
/**
 * <p>Class <i>enum OSDetection</i> provides way to distinguish current running Operating System.<br>
 * OSDetection contains only one static method <i>getOS()</i></p>
 * <p><b>enums:</b><br><i>LINUX, LINUX_OTHER, WINDOWS_10, WINDOWS_OTHER, MAC, UNSUPPORTED</i></p>
 * @method <i>getOS()</i>
 */
public enum OSDetection {
     ...
     */
    public static OSDetection getOS(){
